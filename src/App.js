...
class App extends React.Component{
  ...
  state = {
    ...
    musicPlayer: new Bbox([
      new Box("0" , "J1" , "turquoise" , new Beats('assets/Homura.mp3') , 'aqua' , require("./rengoku.png").default),
      new Box("1" , "J2" , "turquoise" , new Beats('assets/ONE OK ROCK - Mighty Long Fall.mp3') , 'aqua' , require("./OOR.png").default),
      new Box("2" , "J3" , "turquoise" , new Beats("assets/Uru-あなたがいることで因為有你.mp3") , 'aqua' , require("./displayPicts/Ur_u.jpg").default),
      new Box("2" , "E1" , "pink" , new Beats("assets/Arcade Fire - Wake Up.mp3") , 'aqua' , require("./arcadefire.jpg").default),
      new Box("2" , "E2" , "pink" , new Beats("assets/The Band Perry - If I Die Young.mp3") , 'aqua' , require("./displayPicts/bandPerry.jpg").default),
      new Box("2" , "E3" , "pink" , new Beats("assets/Green Day -Boulevard of Broken Dreams.mp3") , 'aqua' , require("./green_day.jpg").default),
      new Box("2" , "C1" , "#F6E7D2" , new Beats("assets/盧廣仲-刻在我心底的名字.mp3") , 'aqua' , require("./刻在我心底的名.png").default),
      new Box("2" , "C2" , "#F6E7D2" , new Beats("assets/周杰倫 一路向北.mp3") , 'aqua' , require("./jay.jpg").default),
      new Box("2" , "C3" , "#F6E7D2" , new Beats("assets/八三夭 831想見你想見你想見你.mp3") , 'aqua' , require("./displayPicts/3000.jpg").default),
   ]),
